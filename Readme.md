...
The LCD display used is available here: [**Communica ESP32 CYB ST7796 3.5inch 320x480**](https://www.communica.co.za/products/bdd-esp32-lvgl-wifi-bt-3-5in-lcd) and it includes an SDCard holder. Schematics for this LCD are in the images folder.
