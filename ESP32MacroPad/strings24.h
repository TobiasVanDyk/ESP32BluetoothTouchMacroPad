...
char str7[] = "cmd\r";                             
char str8[] = "winver\n";  
char str9[] = "cmd /c start /min "" powershell -WindowStyle Hidden -noexit -executionpolicy bypass -File C:\\Temp\\SensorData.ps1"; 
char str10[] = "cmd /c start /min "" powershell -WindowStyle Hidden -noexit -executionpolicy bypass -File C:\\Temp\\FoobarPlaying.ps1";
char str11[] = "cmd /c start /min "" powershell -WindowStyle Hidden -noexit -executionpolicy bypass -File C:\\Temp\\SetDateTime1a.ps1"; 
char str12[] = "cmd /c start /min "" powershell -WindowStyle Hidden -noexit -executionpolicy bypass -File C:\\Temp\\SetDateTime1b.ps1"; 
char str13[] = " ";
char str14[] = "    ";
